                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="pq-grid-container">
                                <div className="pq-masonry" data-next_items="3" data-initial_items="6">
                                    ...
                                    <div className="pq-masonry-item pq-filter-items  ipt-lg-4 style_2">
                                        <div className="pq-portfoliobox-1">
                                            <div className="pq-portfolio-block">
                                                ...
                                                <div className="pq-portfolio-info">
                                                    <h5><Link to="/Design-Details?value=Commercial Space">Commercial Space</Link></h5>
                                                    <span><Link to="/Design-Details?value=Commercial Space">Design</Link></span>
                                                </div>
                                                <div className="pq-btn-container">
